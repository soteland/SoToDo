  ...
  return (
    <div className="flex flex-col min-h-dvh items-center justify-center p-6 bg-neutral-50 dark:bg-neutral-950">
      <div className="w-full max-w-sm space-y-6">
        <h1 className="text-2xl font-semibold text-neutral-900 dark:text-neutral-50 text-center">
          SoToDo
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {info && <p className="text-sm text-neutral-600 dark:text-neutral-400">{info}</p>}
